...
$add_css = '
    ...
    <link rel="stylesheet" href="/css/info-hris/info-hris.css" />
    ...
    <section class="mb--70px color--blue bg--l-blue home__case-study">
        <div class="py--60px container">
            <div class="text-center title--bg title--bg-border title--bg-border-left" data-title-bg="INFORMASI">
                <h2 class="mb-0 font-weight-bold fs-34">Informasi HR dan Teknologi Pendukung</h2>
            </div>

            <div class="fs-14 row justify-content-center">
                <div class="col-md-10 mb-3">
                    <p>Untuk dapat mengikuti tren HR yang terus berkembang, kami menyediakan berbagai informasi seputar teknologi HR, sistem HRIS, HRMS, dan informasi dunia kerja lain yang tentunya akan sangat bermanfaat bagi pengelolaan sumber daya yang lebih baik di perusahaan Anda. </p>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <a href="/ind/fitur-aplikasi-HRD" class="color--blue">
                        <div class="case-study">
                            ...
                            <h5 class="fs-20 font-weight-bold">Fitur Aplikasi HRD</h5>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
