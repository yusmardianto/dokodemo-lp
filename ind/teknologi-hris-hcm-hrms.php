...
<div class="case-study home">
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb--main">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Perbedaan Teknologi HRIS, HCM, dan HRMS</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="mb--70px margintop-80">
        <div class="color--blue container">
            <div class="text-center title--bg title--bg-border title--bg-border-left" data-title-bg="PERBEDAAN">
                <h1 class="mb-0 font-weight-bold fs-34">Perbedaan Mendasar antara Teknologi HRIS, HCM, dan HRMS</h1>
            </div>
    ...
    <section class="mb--70px margintop-80">
        <div class="color--blue container">
            <div class="text-center title--bg title--bg-border title--bg-border-right" data-title-bg="HRIS">
                <h2 class="mb-0 font-weight-bold fs-34">Teknologi HRIS</h2>
            </div>
    ...
    <section class="mb--70px margintop-80">
        <div class="color--blue container">
            <div class="text-center title--bg title--bg-border title--bg-border-left" data-title-bg="HCM">
                <h2 class="mb-0 font-weight-bold fs-34">Teknologi HCM</h2>
            </div>
                ...
                <div class="col-md-10">
                    ...
                    <ol class="list-item">
                        ...
                        <li class="mt-3">
                            ...
                            <p>Teknologi HCM dapat digunakan untuk mencatat <a href="/ind">absensi karyawan</a>, manajemen kehadiran, serta pembuatan jadwal.</p>
                        </li>
                        <li class="mt-3">
