            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="fs-14 list-unstyled list--circle list--circle-border list--circle-border-bottom">
                        ...
                        <li>Manager dapat mengatur tim secara efektif dan efisien karena dapat melihat staf yang cuti sehingga dalam satu waktu tidak ada satu tim yang cutinya bersamaan.</li>
                    </ul>
                </div>
            </div>
        </div>
