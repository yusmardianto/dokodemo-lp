...
<div class="color--blue features">
    ...
    <section class="mt--30px mb--40px features__title">
        <div class="container">
            <div class="text-center title--bg title--bg-border title--bg-border-right" data-title-bg="Fitur Dokodemo-Kerja">                            
                <h1 class="mb-0 font-weight-bold fs-34">Fitur Dokodemo-Kerja (Aplikasi Kerja Remote)</h1>
            </div>
        ...
        <div class="zoom-gallery container">
            ...
            <div class="mb-3 p-3 bg--blue-gradation-left rounded-lg">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <h2 class="mb--20px fs-20 font-weight-bold">Laporan waktu kerja yang akurat berdasarkan task</h2>
                        <p class="mb-0 fs-14">Dari aplikasi yang sudah terinstal pada komputer maupun handphone, pengguna dapat memilih task dan dapat mencatat waktu untuk task tersebut. Hasil tangkapan layar diatas pun hanya diambil saat sesi kerja berjalan (kecuali Aplikasi handphone). Pengguna juga bisa merubah waktu kerja ketika lupa memulai ataupun mematikan waktu kerjanya, ketika ada perubahan ini pihak admin pun akan mendapatkan notifikasi.</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 order-last order-md-first">
                        ...
                        <ul class="mb-0 fs-14 list-unstyled list--circle">
                            ...
                            <li class="mb-2">Memungkinkan pengguna untuk menggunakan waktu kerja produktifnya di tempat yang nyaman untuk bekerja.</li>
