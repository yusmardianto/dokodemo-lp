...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
    <title>Subscribe: Procedure of Dokodemo-Kerja Subscription | Remote Work Management Tool | HR Cloud System</title>
  <!-- Google Tag Manager -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 benefits-item privacy-title">
                    <h2>Introduction</h2>
                    <p>These Website Standard Terms and Conditions written on this webpage shall manage your use of our (PT Logique Digital Indonesia) website, Dokodemo-Kerja accessible at dokodemo-kerja.com.</p>
                ...
                <div class="col-md-12 benefits-item privacy-title">
                    ...
                    <p>
                      Other than the content you own, under these Terms, PT Logique Digital Indonesia (the company what develops Dokodemo-Kerja) and/or its licensors own all the intellectual property rights and materials contained in this Website.
                    </p>
                ...
                <div class="col-md-12 benefits-item privacy-title">
                    ...
                    <ul>
                        <li>publishing any Website material in any other media without permission (from PT Logique Digital Indonesia);</li>
                    ...
                    <p>Certain areas of this Website are restricted from being access by you and PT Logique Digital Indonesia may further restrict access by you to any areas of this Website, at any time, in absolute discretion. Any user ID and password you may have for this Website are confidential and you must maintain confidentiality as well.</p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Your Content</h2>
                  <p>
                    In these Website Standard Terms and Conditions, "Your Content" shall mean any audio, video text, images or other material you choose to display on this Website. By displaying Your Content, you grant PT Logique Digital Indonesia a non-exclusive, worldwide irrevocable, sub-licensable license to use, reproduce, adapt, publish, translate and distribute it in any and all media.
                  </p>
                  <p>Your Content must be your own and must not be invading any third-party’s rights. PT Logique Digital Indonesia reserves the right to remove any of Your Content from this Website at any time without notice.</p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>No Warranties</h2>
                  <p>
                    This Website is provided "as is," with all faults, and PT Logique Digital Indonesia express no representations or warranties, of any kind related to this Website or the materials contained on this Website. Also, nothing contained on this Website shall be interpreted as advising you.
                  </p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Limitation of liability</h2>
                  <p>
                    In no event shall PT Logique Digital Indonesia, nor any of its officers, directors and employees, shall be held liable for anything arising out of or in any way connected with your use of this Website whether such liability is under contract.  PT Logique Digital Indonesia, including its officers, directors and employees shall not be held liable for any indirect, consequential or special liability arising out of or in any way related to your use of this Website.
                  </p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Indemnification</h2>
                  <p>
                    You hereby indemnify to the fullest extent PT Logique Digital Indonesia from and against any and/or all liabilities, costs, demands, causes of action, damages and expenses arising in any way related to your breach of any of the provisions of these Terms.
                  </p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Severability</h2>
                ...
                <div class="col-md-12 benefits-item privacy-title">
                  ...
                  <p>
                    PT Logique Digital Indonesia is permitted to revise these Terms at any time as it sees fit, and by using this Website you are expected to review these Terms on a regular basis.
                  </p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Assignment</h2>
                  <p>
                    The PT Logique Digital Indonesia is allowed to assign, transfer, and subcontract its rights and/or obligations under these Terms without any notification. However, you are not allowed to assign, transfer, or subcontract any of your rights and/or obligations under these Terms.
                  </p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Entire Agreement</h2>
                  <p>
                    These Terms constitute the entire agreement between PT Logique Digital Indonesia and you in relation to your use of this Website, subscription of our service, and supersede all prior agreements and understandings.
                  </p>
                  <p>To add to the terms stated in the "Subscribing Procedure" page, PT Logique Digital Indonesia may add or subtract any of the content without prior warning. New changes will only be applicable to the subscribers after a new Purchase Order is issued.</p>
                </div>
                <div class="col-md-12 benefits-item privacy-title">
                  <h2>Governing Law & Jurisdiction</h2>
                  <p>
                    These Terms will be governed by and interpreted in accordance with the laws of the Republic of Indonesia, and you submit to the non-exclusive jurisdiction of the country and federal courts in Indonesia for the resolution of any disputes.
                  </p>
                </div>
            </div>
        </div>
