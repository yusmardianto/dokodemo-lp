        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb--main">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Definition and Functions of an HRIS Application</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="mb--70px">
        <div class="color--blue container">
            ...
            <div class="fs-14 row justify-content-center">
                <div class="col-md-10">
                    <p>HRIS applications are currently the most widely used form of software by Human Resource Departments (HRD). As we know, the collection of employee data plays an important role for any company. That's why HRIS applications are designed to make it easier for management to comprehensively manage such data all within one secure location without having to search through various different file locations.</p>
                    <p class="mb-0">In order to better understand what the HRIS application is and what it does, we aim to inform you about the definition of HRIS and go through its main functions.</p>
                </div>
            </div>
        </div>
    </section>
