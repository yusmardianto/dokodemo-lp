...
<body>
    ...
    <section class="top-section">
        <div class="free-seminar-section">
            <img src="/img/close.svg" alt="" class="img-close-banner">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-5 offset-sm-1 col-sm-4 offset-md-0 col-md-6 col-lg-6 d-flex align-items-lg-center flex-column flex-md-row">
                        <div class="save-date-wrapper ml-lg-5 mr-4">
                            <img class="save-date-img" src="/img/save-the-date.svg" alt="save-date">
                            <span class="save-date-text">SAVE<br>THE<br>DATE!</span>
                        </div>
                        <div class="description-wrapper">
                            <small class="description-date">30 September 2020</small>
                            <p class="description-title d-md-block d-none"><strong>Utilizing Work-From-Home Technology</strong></p>
                            <small class="description-location">Online seminar in <strong>ZOOM</strong></small>
                        </div>
                    </div>
                    <div class="col-7 col-sm-7 col-md-5 col-lg-6 d-flex align-items-center justify-content-center flex-column flex-xl-row">
                                ...
                                <div class="time-wrapper">
                                    ...
                                    <div class="d-flex">
                                        <span class="digit-format">
                                            <span class="digit">
                                                <hr class="digit-hr">
                                                <div class="digit-text digit-d-1"></div>
                                            </span>
                                        </span>
                                        <span class="digit-format">
                                            <span class="digit">
                                                <hr class="digit-hr">
                                                <div class="digit-text digit-d-2"></div>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                                <div class="time-wrapper">
                                    ...
                                    <div class="d-flex">
                                        <span class="digit-format">
                                            <span class="digit">
                                                <hr class="digit-hr">
                                                <div class="digit-text digit-h-1"></div>
                                            </span>
                                        </span>
                                        <span class="digit-format">
                                            <span class="digit">
                                                <hr class="digit-hr">
                                                <div class="digit-text digit-h-2"></div>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                                <div class="time-wrapper">
                                    ...
                                    <div class="d-flex">
                                        <span class="digit-format">
                                            <span class="digit">
                                                <hr class="digit-hr">
                                                <div class="digit-text digit-m-1"></div>
                                            </span>
                                        </span>
                                        <span class="digit-format">
                                            <span class="digit">
                                                <hr class="digit-hr">
                                                <div class="digit-text digit-m-2"></div>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4">
                            <div class="advantages-item">
                                <img src="/img/home/done-green.svg" class="pr-2 header-icon-verified" alt=""/>
                                <div>
                                    <span class="header-feature">契約期間縛りなし</span>
                                    <!-- <br /> -->
                        ...
                        <div class="col-md-4">
                            <div class="advantages-item">
                                <img src="/img/home/done-green.svg" class="pr-2 header-icon-verified" alt=""/>
                                <div>
                                    <span class="header-feature">即利用開始可能</span>
                                    <!-- <br />
                    ...
                    <div>
                        <div class="home-feature__card">
                            ...
                            <div class="card__content">
                                勤務時間・タスク内容を記録します。日別・週別・月別の労働時間が集計されるので容易に管理できます。 
                            </div>
                        </div>
                    </div>
                    <div>
            ...
            <div class="row mt-3">
                <div class="offset-md-1 col-md-5 home-benefit__card-wrapper">
                    <div class="home-benefit__card">
                        <div class="card__content">
                            <h3 class="card__header">無駄の削減</h3>
                    ...
                    <div class="home-benefit__card">
                        <div class="card__content">
                            <h3 class="card__header">正確で公平な人事評価</h3>
                ...
                <div class="col-md-5 home-benefit__card-wrapper">
                    <div class="home-benefit__card">
                        <div class="card__content">
                            <h3 class="card__header">生産性向上</h3>
                    ...
                    <div class="home-benefit__card">
                        <div class="card__content">
                            <h3 class="card__header">従業員満足度向上</h3>
        ...
        <div class="container-fluid">
            <div class="testimony-slider">
                <div class="testimony-item">
                    <div class="testimony-text">私の家は遠いのでオフィスまで毎日往復で4時間の通勤を強いられていました。混んだバスに長時間乗らなければならないのでオフィスにつく頃にはパワーが失われていました。会社がDokodemo-Kerjaを導入し、週に3日、私にリモートワークを許可してくれたことで、100%自分のパワーを仕事に注げるようになりました。往復の4時間を仕事や自分の趣味の時間に使えるようになったので幸福度が上がりました。</div>
                    <p class="testimony-author"><strong>Rafid</strong> - Front End Developer</p>
                </div>
                <div class="testimony-item">
                    <div class="testimony-text">私は働きながら夜間学校に通っています。Dokodemo-Kerjaでどこからでも、正確に私が働いたことをマネージャーに証明することができるので、学校に通っていることが仕事に悪影響を与えてないことを証明できています。時には朝早く仕事し、時には学校が終わったあとの深夜に働いて規定の労働時間を満たしています。生産性も上がったと感じています。</div>
                    <p class="testimony-author"><strong>Angga</strong> - Designer</p>
                </div>
                <div class="testimony-item">
                    <div class="testimony-text">いままで、いくつかのスタッフグループのお祈り（お祈りの後の休憩）が長すぎることがとても気になっていました。お祈りをしないスタッフにとってフェアでないからです。ただ、私から指摘するにはセンシティブ過ぎる問題で解決することができないまま長い時間が過ぎていました。Dokodemo-Kerjaを導入し、皆にお祈り時、休憩時の計測ストップを徹底した後は、とても公平になり、また休憩が長かったスタッフ達の休憩時間が短くなりました。（休憩していると規定の労働時間に達しないことが自ら分かるので）</div>
                    <p class="testimony-author"><strong>Mizuho Yamada</strong> - Manager of Back Office</p>
                </div>
                <div class="testimony-item">
                    <div class="testimony-text">人事部のスタッフとして従業員が勤務時間中にYoutubeを見たり、オンラインゲームをしたり、業務外のことをするのを防ぐ、注意することに難しさを感じていました。彼らも見つからないように行いますし、発見しても言い方が難しく、言い争いになってしまうこともありました。<br>
                    Dokodemo-Kerjaではランダムにスクリーンキャプチャをとることが抑止力になります。それだけでだいぶ業務外のことをする従業員は減りましたし、それでも治らないスタッフにはDokodemo-Kerjaで証拠をもって話ができるので大きな効果がでています。</div>
                    <p class="testimony-author"><strong>Kevin</strong> - Staff HR</p>
                </div>
                <div class="testimony-item">
                    <div class="testimony-text">オンラインで出勤退勤を自己申告でつけさせるなんて馬鹿げていると思っていました。誰も正直に深刻するわけがないと。ランダムに撮られるスクリーンキャプチャが効果的で虚偽深刻ができないようになっていることが分かり、Dokodemo-Kerjaをとても気に入っています。会社にとっても従業員にどちらにとってもメリットのあるツールだと思います。</div>
                    <p class="testimony-author"><strong>Arie</strong> - HR</p>
                </div>
                <div class="testimony-item">
                    <div class="testimony-text">私には生まれたばかりの子供がいます。ベビーシッターに私の出社中の赤ちゃんの世話をお願いしていたのですが、主人と相談して、自分達で子供の成長を見守りたいと決めました。退職しなくてならないかと思いましたが、会社がDokodemo-Kerjaを使うことを条件にフルリモート勤務を許可してくれました。とても幸せです。</div>
                    <p class="testimony-author"><strong>Sisca</strong> - Programmer</p>
                </div>
                <!-- <div class="testimony-item">
                    <div class="testimony-text">I often have to reprimand employees who take lengthy smoking breaks. On
                ...
                <div class="testimony-item">
                    <div class="testimony-text">母親の看病のためにキャリアを諦めなければいけない状況でした。会社がDokodemo-Kerjaを導入してくれたお陰で、会社をやめることなく、正社員としての契約を継続することができました。いまは週に4日在宅勤務、週に1日だけ出社しています。</div>
...
<?php /*   <section  class="news-list-container">
    ...
    <!-- end of  modal popup -->
    <script>
        <?php include '../js/seminar-banner/seminar-banner.js'?>
    </script>
</body>
