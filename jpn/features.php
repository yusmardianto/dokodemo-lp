<?php 
    ...
    $meta_description = 'Dokodemo-Kerjaを導入することで従業員がどこで・いつ働いても正確に勤務時間と内容を把握することが可能となります。リモートワーク制度の導入を助けます。インドネシアのWeb制作会社が開発したクラウドツール。';
    ...
    $og_title = 'リモートワーク管理ツール | Dokodemo-Kerja';
...
<div class="color--blue features">
    ...
    <section class="mt--30px mb--40px features__title">
        <div class="container">
            <div class="text-center title--bg title--bg-border title--bg-border-right" data-title-bg="Dokodemo-Kerjaの機能">                            
                <h1 class="mb-0 font-weight-bold fs-34">Dokodemo-Kerjaの機能</h1>
            </div>
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <p class="fs-14">Dokodemo-Kerjaは勤務時間トラッキング機能（スクリーンキャプチャ機能あり）をベースにした勤怠管理、作業内容管理システムです。勤怠管理、残業代の計算、有休消化数の計算など人事業務の効率化に有効なだけでなく、リモートワークや時短勤務などフレキシブルな働き方の導入を可能にします。結果としてこれが従業員の生産性を向上することに繋がります。</p>
                </div>
            </div>            
        </div>
    </section>
        ...
        <div class="zoom-gallery container">
            ...
            <div class="mb-3 p-3 bg--blue-gradation-left rounded-lg">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <h2 class="mb--20px fs-20 font-weight-bold">タスク別に作業時間を正確に記録します</h2>
                        <p class="mb-0 fs-14">端末にインストールされたアプリケーションより、タスクを選択して作業の開始、と終了を記録します。作業中のステータスのときに上記のスクリーンキャプチャが取得されます。開始忘れ、終了忘れのために、時間編集機能があります。編集されたことは管理者に通知されます。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3 p-3 bg--blue-gradation-left rounded-lg">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <h2 class="mb--20px fs-20 font-weight-bold">非デスクワークも管理</h2>
                        <p class="mb-0 fs-14">スマホアプリをご利用いただくことで、外回り社員の行動履歴をトラッキングできます。勤務時間と場所を記録します。午前中はデスクワークで午後は客先でミーティングなどの場合にも勤務時間を完全に把握可能です。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3 p-3 bg--blue-gradation-left rounded-lg">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <h2 class="mb--20px fs-20 font-weight-bold">休暇の管理</h2>
                        <p class="mb-0 fs-14">Dokodemo-Kerjaを通して、休暇の申請承認を行えます。HRは休暇取得数や有給休暇残数の管理を容易に行えます。</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 order-last order-md-first">
                        ...
                        <ul class="mb-0 fs-14 list-unstyled list--circle">
                            ...
                            <li class="mb-2">生産性高く働ける時に、心地よい場所で作業をすることを可能にします。</li>
