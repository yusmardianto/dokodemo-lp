<?php 
    $page = 'case-study/';
    $page_title = 'WFHを実現 | 働き方改善支援ツール | さぼり防止 | インドネシア事例';

    $meta_description = 'Dokodemo-Kerjaを利用することで、従業員にWFHを許容できる、さぼり防止、時短勤務制度を導入できた、残業時間の計算の自動化などでHR業務効率化など、さまざまな導入メリットを感じていただけます。幾つかのDokodemo-Kerjaの導入事例を紹介します。';
    ...
    $og_title = 'Dokodemo-KerjaでWFHを実現';
