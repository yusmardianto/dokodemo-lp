...
<!-- End Google Tag Manager (noscript) -->
    ...
    <section class="mb-5">
        <div class="container">
            <h1 class="text-center mb-5">「Dokodemo-Kerja」活用ストーリー1: LOGIQUE</h1>
            <div class="case-study__story mx-3 mx-lg-0">
                <div class="row">
                    ...
                    <div class="col-lg-6 pl-0 pl-lg-3">
                        ...
                        <p>先にお話ししておくと、 もともと、『Dokodemo-Kerja（ドコデモ・クルジャ）』は、LOGIQUE社内の勤務時間管理ツールでした。ちなみに、「クルジャ」とはインドネシア語で「仕事」という意味です。このツールは、社員がいつでもどこでも、効率的に働けるようサポートしたい、組織の働き方を柔軟に変えていきたい、という目的で、“どこででも、自分スタイルで効率的に仕事しよう“＝「Dokodemo-Kerja（ドコデモ・クルジャ）」として開発しました。</p>
                        <p class="mb-0">多くの企業様が課題とされている、社員の働き方をいかに効率化し質を向上させていくかー。『Dokodemo-Kerja』が、その課題解決のための施策の一つとなることを願い、私たちの開発ストーリーをかいつまんでお話します。</p>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p>そこで、さらなる適正かつ納得性の高い業務の可視化を目的に、『Dokodemo-Kerja』を開発しました。これが、2017年11月のことでした。</p>
                            ...
                            <p class="mb-0"> この段階で、リモートワークをさらに拡充できる下地ができました。</p>
                        </div>
