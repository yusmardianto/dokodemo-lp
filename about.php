...
<head>
    ...
    <title>Dokodemo-Kerja | About</title>
	<!-- Google Tag Manager -->
    ...
    <section class="hr-manager-benefits">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 benefits-item">
                    <h3>2. Determine who your best employee is more objectivelys</h3>
                    <p>
