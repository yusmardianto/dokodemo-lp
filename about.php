    ...
    <section class="hr-manager-benefits">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 benefits-item">
                    <h3>2. Determine who your best employee is more objectively</h3>
                    <p>
                ...
                <div class="col-md-6 benefits-item">
                    <h3>3. Save up millions on lost time</h3>
                    <p>
                ...
                <div class="col-md-6 benefits-item">
                    <h3>4. Increase employee retention</h3>
                    <p>
                ...
                <div class="col-md-6 benefits-item">
                    ...
                    <p>
                        ...
                        <br><strong>With Dokodemo-Kerja, employees no longer need to worry about being stuck in traffic, being late, or transportation breaking down, because they can now work from home.</strong>
                    </p>
                </div>
                <div class="col-md-6 benefits-item">
                    <h3>7. Taking care of Important Documents</h3>
                    <p>
