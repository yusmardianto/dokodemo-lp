        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <h3 class="blue2 fw-500">Q. Can Dokodemo-Kerja operate on mobile devices?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. How do I know if PC and Mac can run Dokodemo-Kerja?</h3>
                    <p>
                        A. Dokodemo-Kerja supports Windows, Linux, and Macintosh.
                    </p>
                    <h3 class="blue2 fw-500">Q. What languages are available for Dokodemo-Kerja?</h3>
                    <p>
                        A. Currently, Dokodemo-Kerja is only available in English and Indonesian.
                    </p>
                    <h3 class="blue2 fw-500">Q. Is there a demo version of Dokodemo-Kerja that I can try before purchasing it?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. What if a problem occurs when I use Dokodemo-Kerja?</h3>
                    <p>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <h3 class="blue2 fw-500">Q. How does Dokodemo-Kerja record employee's work hours?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. Does Dokodemo-Kerja need internet access?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. What will happen if my internet disconnects while running Dokodemo-Kerja?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. Can Dokodemo-Kerja be used with Mac's latest Catalina?</h3>
                    <p>
                        A. Yes, but you will need to update your security settings and allow the app to record your screen.
                    </p>
                    <h3 class="blue2 fw-500">Q. Can Dokodemo-Kerja be used with Windows 7?</h3>
                    <p>
                        A. Yes, it is compatible with Windows 7.
                    </p>
                    <h3 class="blue2 fw-500">Q. Where do you save the screenshots? Can Logique employees see the images?</h3>
                    <p>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <h3 class="blue2 fw-500">Q. How effective is Dokodemo-Kerja on improving employee productivity?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. How does Dokodemo-Kerja manage staffs who work outside of the office?</h3>
                    <p>
                        A. You can use the Dokodemo-Kerja Mobile Application, it will help you to track their Work Hours and Locations.
                    </p>
                    <h3 class="blue2 fw-500">Q. I am interested in implementing Dokodemo-Kerja in my company. How do I proceed?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q. How do I set up Dokodemo-Kerja?</h3>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <h3 class="blue2 fw-500">Q. Is there a minimum contract period needed to use Dokodemo-Kerja?</h3>
                    <p>
                        A. There is no minimum contract period, but we suggest trying it out for at least 1 month.
                    </p>
                    <h3 class="blue2 fw-500">Q: How does the payment work?</h3>
                    <p>
                    ...
                    <h3 class="blue2 fw-500">Q: Do I have to pay for an employee who uses the program for less than a month?</h3>
                    <p>
