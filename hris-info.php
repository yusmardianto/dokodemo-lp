...
<div class="case-study home">
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb--main">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">HRIS Info</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section class="mb--70px color--blue bg--l-blue home__case-study">
        <div class="py--60px container">
            <div class="text-center title--bg title--bg-border title--bg-border-left" data-title-bg="INFORMASI">
                <h2 class="mb-0 font-weight-bold fs-34">Information on HR and Supporting Technologies</h2>
            </div>
            ...
            <div class="pt--20px row text-center slick--blue-arrow case-study__slide">
                <div class="col-md-4">
                    <a href="/HRD-app-features" class="color--blue">
                        <div class="case-study">
                            <picture>
                                <img src="/img/swiper-img/fitur-aplikasi-hrd.jpg" alt="HRD App Features" class="img-fluid mb-3 rounded-lg" loading="lazy">
                            </picture>
                            <h5 class="fs-20 font-weight-bold">HRD App Features</h5>
                        </div>
                    </a>
                </div>
                <div class="col-md-4">
    ...
    <section class="mb--70px color--blue">
        <div class="container">
            ...
            <div class="fs-14 row justify-content-center">
                <div class="col-md-10">
                    <p>In order to be able to keep up with these evolving HR trends, we aim to provide information in regards to topics such as HR technology, HRIS systems, HRMS, and other insights which can prove useful with regards to the resource management capabilities within your company.</p>
                </div>
            </div>
