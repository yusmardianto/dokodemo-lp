...
?>
    ...
    <div class="home">
        ...
        <section class="d-none top-section">
            <div class="container">
                <div class="row">
        ...
        <section class="d-none feature-content mt-5">
            <div class="container">
                <div class="row">
                    <div class="offset-md-1 col-md-10">
        ...
        <section class="d-none screenshots mt-5">
        ...
        <section class="d-none benefit-container">
        ...
        <section class="d-none case-study__container">
            <div class="container my-5">
                <div class="row">
                    <div class="col-md-12">
        ...
        <section class="d-none user-testimony" id="testimony">
