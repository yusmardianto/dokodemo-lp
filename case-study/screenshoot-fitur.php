<?php 
    ...
    $page_title = 'Dokodemo-Kerja Case Study #3 | Remote Work Tracking Tool';

    $meta_description = 'Dokodemo-Kerja Case Study looks at implementing the employee monitoring, remote management tool developed by Logique in an Accounting firm.';
    $meta_keyword = 'dokodemo, dokodemo-kerja, dokodemo case, dokodemo story, accounting firm tool,  logique digital Indonesia, THR, employee monitoring, HR management, management tool, HR department';

    $og_title = 'Dokodemo-Kerja Case Study #3 | Remote Work Tracking Tool';
...
<div class="">
    ...
    <section class="mb-5">
        <div class="container">
            <h1 class="text-center mb-5">Dokodemo Case Study #6: <br>Maximizing Methods of Work Efficiency for Accounting Companies</h1>
            <div class="case-study__story">
                <div class="row">
                    <div class="offset-md-1 col-md-10">
                    <blockquote class="blockquote text-center mb-5">
                        <p class="mb-0">“As an accounting firm, we take on high levels of work at the start & end of every month. Through Dokodemo-Kerja, we can control the overall workload during peak seasons by implementing more flexible and efficient method of working.”</p>
