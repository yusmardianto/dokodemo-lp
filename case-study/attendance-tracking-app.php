...
<div class="">
    ...
    <section class="mb-5">
        <div class="container">
            <h1 class="text-center mb-5">Dokodemo Case Study #2: <br>Multifunctional HR Application used for Attendance tracking, monitoring & Employee Work Evaluation</h1>
            <div class="case-study__story">
                <div class="row">
                    <div class="offset-md-1 col-md-10">
                        <blockquote class="blockquote text-center mb-5">
                            <p class="mb-0">“Since our workforce currently exceed 50 people, employee performance evaluation can be difficult. However, Dokodemo-Kerja has simplified the appraisal process so that it can be conducted fairly and objectively.”</p>
