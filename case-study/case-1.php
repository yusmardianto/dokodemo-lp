<?php 
    ...
    $page_title = 'Remote Work Management | Dokodemo-Kerja Case Study #1';

    $meta_description = 'Dokodemo-Kerja Case Study looks at implementing remote work strategies into Logique, using the HR tool for managers & team leaders.';
    $meta_keyword = 'dokodemo, dokodemo-kerja, dokodemo case, dokodemo story, team leaders tool, tool for managers, manage employees, working in teams, remote working strategies, remote work tool, HR tool, logique';

    $og_title = 'Remote Work Management | Dokodemo-Kerja Case Study #1';
